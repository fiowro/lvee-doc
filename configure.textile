...
User should be created via website, by clicking the "register" link on top. After that you should run rails console in the terminal and set admin role for the very first user with a special script:
