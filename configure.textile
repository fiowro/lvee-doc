...
Do not forget to use your real gmail account name and password.After the "installation":install.textile lvee engine still needs to surpass some configuration. 
